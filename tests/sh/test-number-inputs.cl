kernel void test_number_inputs(global float *a0, global float *a1, global float *a2, global float *a3, global float *a4,
                               ...
                               global float *a30, global float *result) {
