...
{
    fixture->addr = g_strdup ("kiro://127.0.0.1:5555");
}
...
{
    GError *error = NULL;
    UfoMessenger *msger = UFO_MESSENGER (ufo_kiro_messenger_new ());
    gchar *addr = g_strdup ("kiro://127.0.0.1:5555");
...
static void test_kiro_messenger (Fixture *fixture, gconstpointer unused)
{
...
void
test_add_kiro_messenger (void)
{
    g_test_add ("/opencl/kiro_messenger/test_messenger",
                Fixture, NULL,
                setup, test_kiro_messenger, teardown);
}
